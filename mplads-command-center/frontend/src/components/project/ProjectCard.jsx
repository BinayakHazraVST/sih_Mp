      ...
      <div>
        ...
        <div className="pt-3 border-t border-slate-100 grid grid-cols-2 gap-2 text-xs">
          <div>
            ...
            <span className="font-bold text-slate-800">{formatCurrency(sanctioned, true)}</span>
          </div>
          <div>
            <span className="text-slate-400 text-[11px] font-medium block">Utilized</span>
            <span className="font-bold text-emerald-700">{formatCurrency(utilized, true)}</span>
          </div>
        </div>
      </div>
