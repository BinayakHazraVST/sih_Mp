...
export const ProjectFilters = ({ filters, onChange }) => {
  return (
    <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl flex flex-col md:flex-row gap-3 items-center justify-between mb-6">
      {/* Search Input */}
      <div className="relative w-full md:w-72">
        ...
        <input
          ...
          className="w-full bg-slate-800/80 border border-slate-700/80 rounded-lg pl-9 pr-3 py-2 text-xs text-slate-100 placeholder-slate-400 focus:outline-none focus:border-indigo-500"
        />
      </div>
